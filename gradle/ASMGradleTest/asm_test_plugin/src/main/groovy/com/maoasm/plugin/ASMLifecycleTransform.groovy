...
class ASMLifecycleTransform extends Transform{
    ...
    void transform(TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        ...
        if(transformOutputProvider !=null) transformOutputProvider.deleteAll()
            ...
            TransformInput transformInput ->
                transformInput.directoryInputs.each {
                       ...
                       DirectoryInput directoryInput->
                        ...
                        if(file){
                            file.traverse(type: FileType.FILES, nameFilter: ~/.*\.class/) { File clazz ->
                                //获取所有 class 文件
                                println("print project class： $clazz.name")
